#!/usr/bin/env python3
"""Verify the fixed IDF/lwIP source pair for the ESP Container C3 profile."""
...
def main() -> int:
    ...
    try:
        ...
        parser.exit(1, f"esp-container SDK check failed: {error}\n")
    print("esp-container SDK source matches sdk-lock.json")
    return 0
